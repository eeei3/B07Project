...
public class DatabaseCommunicator {
    ...
    EcoTrackerHomeFragment ecotrackerhomefragment;
    ...
    public DatabaseCommunicator(DatabaseReference db, EcoTrackerHomeFragment ecotrackerhomefragment) {
        this.database = db;
        data = "";
        this.rawiter = 0;
        this.calciter = 0;
        this.ecotrackerhomefragment = ecotrackerhomefragment;
    }
        ...
        userRef.get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    calciter++;
                    //update the ui interacrions here
                    ecotrackerhomefragment.transportEmissions.setText("Transportation: " + String.valueOf(calc.getTotalEmission()));
                }
                else {

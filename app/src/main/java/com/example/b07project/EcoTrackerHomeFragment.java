...
public class EcoTrackerHomeFragment extends Fragment {
    ...
    private TextView TransportEmmsion;

    public TextView titleText, summaryTitle, transportEmissions, foodEmissions, shoppingEmissions, energyBills;
    public CalendarView calendarView;
    public Button logActivityButton, detailActivityButton;
    static DatabaseReference database;

    static DatabaseCommunicator db;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        DatabaseCommunicator  db = new DatabaseCommunicator(database, this);
